...
api_base_url = "https://dragon.garden" #todo: this shouldn't be hardcoded
...
if random.randint(1, 2) == 2:
	#time for some nonstandard behaviour babey yesssss
	choice = random.randint(1, 3)
	if choice == 1:
		compliments = ["you are so pretty", "ur really nice", "i like you a lot, just thought you should know",
		"youre toots are really excellent", "omg ur goals <3", "i bet youre probably the best person",
		"i love you in ways that this pathetic interface is incapable of letting me describe", "youre my favorite tooter", "ur so cute aaaa!",
		"i hope you have a nice day", "how is it possible to be such an amazing friend?",
		"your entire tl a huge blessing on this site", "you're glorious",
		"i love you", "this fediverse is amazing because it's where i met you",
		"i hope that the relative time part you are experiencing is a nice one", "you're the best", "ur so valid", "you're a really positive role-model for me",
		"im just thinkin about those beans, thought you should know"]
		prefaces = ["hewwo", "guess what", "", "special message for",
		"telegram for", "excuse me, im sorry to but you but",
		"this is a callout post.", "hello, my name is bZZZt! EEEEEERROR, i just wanted to say"]
		person = ["{} @lady_lumb@dragon.garden {}", "{} @lynnesbian@deadinsi.de {}", "{} @amy@dragon.garden {}"]
		toot = random.choice(person).format(
			random.choice(prefaces), random.choice(compliments))
	elif choice == 2:
		girls = ["dragon", "robot", "fat", "goth", "bookish", "gay", "tall",
		"queer", "my kind of", "sapphic", "linux", "lesbian", "SJW", "anarchist",
		"socialist", "short", "big", "nervous", "shy", "gamer", "femme", "butch", "trans",
		"transbian", "lesbian", "aromantic", "quiet", "smart", "skeleton", "undead", "spider", "vampire",
                "cryptid", "bigfoot"]
		compliments = ["so cute", "always a fan favorite", "really so nice", "the best",
		"all married to each other", "so fucking gay", "great", "literally the best thing there ever was or ever will be",
		"the reason i carry on", "why i'm a lesbian", "worth summoning an undead army to wage war on the living for",
		"edible", "just really neat", "awesome and i'm jealous of them",
		"who i want to beat me up"]
		toot = "{} girls are {}".format(random.choice(girls),
			random.choice(compliments))
	elif choice == 3:
		nota = ["goth", "gamer", "fan", "linux nerd", "programmer", "wrestler", "member of parliment",
		"cool cat", "communist", "anarchist", "lesbian", "slimegirl", "good friend", "one",
		"socialist", "australian"]
		unless = ["u sleep in a coffin", "you can 100% run ocarina of time in under 12 parsecs", "you compile ur own kernel", "you can speak latin",
		"you are all married to each other", "you are so fucking gay", "you piledrive the announcers", "you can sing the whole pokerap from memory",
		"you read theory in the bathtub", "you can name five of my albums", "you can fit inside this water bottle",
		"you can play playstation with ur feet", "unless like girls", "you carry a molotov around with you",
		"you beat me up pls uwu", "you are gay", "can kill a dingo with spare change"]
		toot = "sorry, ur not a real {} unless {}".format(random.choice(nota),
			random.choice(unless))
